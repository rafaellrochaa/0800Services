...
namespace ControladorServicos.Rotalog {
    using System.Data;
    ...
    public interface WebServiceRotaSoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        ControladorServicos.Rotalog.UploadArquivoResponse UploadArquivo(ControladorServicos.Rotalog.UploadArquivoRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://jointecnologia.com/UploadArquivo", ReplyAction="*")]
        System.Threading.Tasks.Task<ControladorServicos.Rotalog.UploadArquivoResponse> UploadArquivoAsync(ControladorServicos.Rotalog.UploadArquivoRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://jointecnologia.com/CancelaColeta", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        string CancelaColeta(string sLogin, string sSenha, int CodigoColeta);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://jointecnologia.com/CancelaColeta", ReplyAction="*")]
        System.Threading.Tasks.Task<string> CancelaColetaAsync(string sLogin, string sSenha, int CodigoColeta);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface WebServiceRotaSoapChannel : ControladorServicos.Rotalog.WebServiceRotaSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WebServiceRotaSoapClient : System.ServiceModel.ClientBase<ControladorServicos.Rotalog.WebServiceRotaSoap>, ControladorServicos.Rotalog.WebServiceRotaSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        ControladorServicos.Rotalog.UploadArquivoResponse ControladorServicos.Rotalog.WebServiceRotaSoap.UploadArquivo(ControladorServicos.Rotalog.UploadArquivoRequest request) {
        ...
        public string UploadArquivo(string sLogin, string sSenha, int CodigoColeta, string sDescricaoArquivo, string sNomeOriginalArquivo, byte[] Arquivo) {
            ControladorServicos.Rotalog.UploadArquivoRequest inValue = new ControladorServicos.Rotalog.UploadArquivoRequest();
            ...
            ControladorServicos.Rotalog.UploadArquivoResponse retVal = ((ControladorServicos.Rotalog.WebServiceRotaSoap)(this)).UploadArquivo(inValue);
            return retVal.UploadArquivoResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<ControladorServicos.Rotalog.UploadArquivoResponse> ControladorServicos.Rotalog.WebServiceRotaSoap.UploadArquivoAsync(ControladorServicos.Rotalog.UploadArquivoRequest request) {
            return base.Channel.UploadArquivoAsync(request);
        }
        
        public System.Threading.Tasks.Task<ControladorServicos.Rotalog.UploadArquivoResponse> UploadArquivoAsync(string sLogin, string sSenha, int CodigoColeta, string sDescricaoArquivo, string sNomeOriginalArquivo, byte[] Arquivo) {
            ControladorServicos.Rotalog.UploadArquivoRequest inValue = new ControladorServicos.Rotalog.UploadArquivoRequest();
            inValue.sLogin = sLogin;
            inValue.sSenha = sSenha;
            inValue.CodigoColeta = CodigoColeta;
            ...
            inValue.sNomeOriginalArquivo = sNomeOriginalArquivo;
            inValue.Arquivo = Arquivo;
            return ((ControladorServicos.Rotalog.WebServiceRotaSoap)(this)).UploadArquivoAsync(inValue);
        }
        
        public string CancelaColeta(string sLogin, string sSenha, int CodigoColeta) {
            return base.Channel.CancelaColeta(sLogin, sSenha, CodigoColeta);
        }
        
        public System.Threading.Tasks.Task<string> CancelaColetaAsync(string sLogin, string sSenha, int CodigoColeta) {
            return base.Channel.CancelaColetaAsync(sLogin, sSenha, CodigoColeta);
        }
    }
}
